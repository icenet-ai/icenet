...
def unet_batchnorm(input_shape: object,
    ...
    conv1 = Conv2D(int(64*n_filters_factor), filter_size, activation='relu',
    ...
    conv2 = Conv2D(int(128*n_filters_factor), filter_size, activation='relu',
    ...
    conv3 = Conv2D(int(256*n_filters_factor), filter_size, activation='relu',
    ...
    conv4 = Conv2D(int(256*n_filters_factor), filter_size, activation='relu',
